#ifndef ALTERNATERULESET_H
#define ALTERNATERULESET_H

#include "RuleSetInterface.h"

class AlternateRuleSet : public RuleSetInterface
{
  public:
   /**
    ...
    *
    * @return True if the player can move backwards; false otherwise.
    */ 
