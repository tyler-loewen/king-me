#ifndef ALTERNATEBOARD_H
#define ALTERNATEBOARD_H
...
/**
 * An alternate board for checkers.
 */
class AlternateBoard : public BoardInterface
{
  public:
   /**
    * Construsts an alternate game board.
    *
    * @param d - The display size used to create the board.
    */
   AlternateBoard(const Display &d, unsigned char tile1_r = 255, unsigned char tile1_g = 252,
		unsigned char tile1_b = 195, unsigned char tile2_r = 55,
		unsigned char tile2_g = 29, unsigned char tile2_b = 12);
