...
AlternatePlayerOnePiece::AlternatePlayerOnePiece(unsigned char player1_r, unsigned char player1_g,
...
void AlternatePlayerOnePiece::drawPiece(bool is_king, unsigned int x, unsigned int y, unsigned int width, unsigned int height) const
{
...
AlternatePlayerOnePiece::~AlternatePlayerOnePiece()
{
