...
AlternateBoard::AlternateBoard(const Display &d, unsigned char tile1_r, unsigned char tile1_g,
...
unsigned int AlternateBoard::getX() const
{
   return board_pos_x;
}

unsigned int AlternateBoard::getY() const
{
   return board_pos_y;
}

unsigned int AlternateBoard::getWidth() const
{
   return board_width;
}

unsigned int AlternateBoard::getHeight() const
{
   return board_height;
}

void AlternateBoard::getCellDimensions(unsigned int x, unsigned int y, float &cell_x, float &cell_y, float &cell_width, float &cell_height) const
{
   if (x >= 8 || y >= 8)
   {
...
void AlternateBoard::draw() const
{
...
void AlternateBoard::getCell(int screen_x, int screen_y, unsigned int &cell_x, unsigned int &cell_y) const
{
