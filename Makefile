...
OBJECTS = DefaultRuleSet.o DefaultHUD.o Main.o Simulator.o GameSimulator.o Display.o DefaultBoard.o PlayerOnePiece.o PlayerTwoPiece.o SelectedCellHighlight.o
